...
def get_training_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    cifar100_training = torchvision.datasets.CIFAR100(root=os.environ.get('CIFAR_ROOT'), train=True, download=True, transform=transform_train)
...
def get_test_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    cifar100_test = torchvision.datasets.CIFAR100(root=os.environ.get('CIFAR_ROOT'), train=False, download=True, transform=transform_test)
